...
const EasySplitApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * x_idempotency_key?: string, 
         */
        pGESDownloadVendorsDocs: async (doc_type: string, vendor_id: string,  x_request_id?: string, x_idempotency_key?: string,  options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
const EasySplitApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async pGESDownloadVendorsDocs(doc_type: string, vendor_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VendorDocumentDownloadResponse>> {
                const localVarAxiosArgs = await localVarAxiosParamCreator.pGESDownloadVendorsDocs(doc_type, vendor_id, x_request_id, x_idempotency_key, options);
                var url = "https://sandbox.cashfree.com/pg";
                if(Cashfree.XEnvironment == CFEnvironment.PRODUCTION) {
                    url = "https://api.cashfree.com/pg"
                }
...
export class Cashfree {
     ...
     * @memberof EasySplitApi
     */
    public static PGESDownloadVendorsDocs(doc_type: string, vendor_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        if(Cashfree.XEnableErrorAnalytics) {
        Sentry.init({
            dsn: 'https://748d9dcfc4286488867c59651cb6121a@o330525.ingest.sentry.io/4506692796350464',
            // Performance Monitoring
        ...
        try {
            return EasySplitApiFp().pGESDownloadVendorsDocs(doc_type, vendor_id, x_request_id, x_idempotency_key, options).then((request) => request(Cashfree.axios, Cashfree.basePath));
        } catch (error) {
            if(Cashfree.XEnableErrorAnalytics) {
                Sentry.captureException(error);
            }
