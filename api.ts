 ...
 * @export
 */
const DefaultApiAxiosParamCreator = function (cashfree: Cashfree) {
    return {
        /**
         ...
         */
        terminalCreateQRCodes: async (x_api_version: string,  x_request_id?: string, x_idempotency_key?: string, CreatePartnerVpaRequest?: CreatePartnerVpaRequest,  options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'x_api_version' is not null or undefined
            ...
            setSearchParams(localVarUrlObj, localVarQueryParameter);
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(CreatePartnerVpaRequest, localVarRequestOptions)
         ...
         * x_request_id?: string, 
         */
        terminalGetQRCodes: async (x_api_version: string, status: string, cf_terminal_id: string,  x_request_id?: string, x_idempotency_key?: string,  options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'x_api_version' is not null or undefined
 ...
 * @export
 */
const DefaultApiFp = function(cashfree: Cashfree) {
    const localVarAxiosParamCreator = DefaultApiAxiosParamCreator(cashfree)
    return {
        /**
         * Use this API to create a pre-activated vpa for partner.
         * @summary Create Pre-Activated Vpas for partner
         ...
         * @throws {RequiredError}
         */
        async terminalCreateQRCodes(x_api_version: string, x_request_id?: string, x_idempotency_key?: string, CreatePartnerVpaRequest?: CreatePartnerVpaRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<StaticQrResponseEntity>>> {
                const localVarAxiosArgs = await localVarAxiosParamCreator.terminalCreateQRCodes(x_api_version, x_request_id, x_idempotency_key, CreatePartnerVpaRequest, options);
                var url = "https://sandbox.cashfree.com/pg";
                if(cashfree.XEnvironment == CFEnvironment.PRODUCTION) {
                    url = "https://api.cashfree.com/pg"
                }
         ...
         * @throws {RequiredError}
         */
        async terminalGetQRCodes(x_api_version: string, status: string, cf_terminal_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<StaticQrResponseEntity>>> {
                const localVarAxiosArgs = await localVarAxiosParamCreator.terminalGetQRCodes(x_api_version, status, cf_terminal_id, x_request_id, x_idempotency_key, options);
                var url = "https://sandbox.cashfree.com/pg";
                if(cashfree.XEnvironment == CFEnvironment.PRODUCTION) {
                    url = "https://api.cashfree.com/pg"
                }
...
const SoftPOSApiAxiosParamCreator = function (cashfree: Cashfree) {
    return {
         ...
         * x_request_id?: string, 
         */
        sposFetchTerminalSoundboxVpa: async (x_api_version: string, device_serial_no: string, cf_terminal_id: string,  x_request_id?: string, x_idempotency_key?: string,  options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'x_api_version' is not null or undefined
         ...
         * x_request_id?: string, 
         */
        sposUpdateSoundboxVpa: async (x_api_version: string, cf_terminal_id: string, UpdateSoundboxVpaRequest: UpdateSoundboxVpaRequest,  x_request_id?: string, x_idempotency_key?: string,  options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'x_api_version' is not null or undefined
...
export class Cashfree {
    ...
    constructor(XEnvironment: CFEnvironment, XClientId?: string, XClientSecret?: string, XPartnerKey?: string, XClientSignature?: string, XPartnerMerchantId?: string, XEnableErrorAnalytics?: boolean, axios?: AxiosInstance) {
        ...
        if(this.XEnableErrorAnalytics) {
            ...
            scope.setExtra('release', "5.0.1-beta-3");
        }
        if(axios) {
            this.axios = axios;
        }
    ...
    public PGCreateCustomer(x_api_version: string, CreateCustomerRequest: CreateCustomerRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
    ...
    public TerminalCreateQRCodes(x_api_version: string, x_request_id?: string, x_idempotency_key?: string, CreatePartnerVpaRequest?: CreatePartnerVpaRequest, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
            return DefaultApiFp(this).terminalCreateQRCodes(x_api_version, x_request_id, x_idempotency_key, CreatePartnerVpaRequest, options).then((request) => request(this.axios, this.basePath));
        } catch (error) {
            if(this.XEnableErrorAnalytics) {
                Sentry.captureException(error);
            }
    ...
    public TerminalGetQRCodes(x_api_version: string, status: string, cf_terminal_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
            return DefaultApiFp(this).terminalGetQRCodes(x_api_version, status, cf_terminal_id, x_request_id, x_idempotency_key, options).then((request) => request(this.axios, this.basePath));
        } catch (error) {
            if(this.XEnableErrorAnalytics) {
                Sentry.captureException(error);
            }
    ...
    public PGAcceptDisputeByID(x_api_version: string, dispute_id: number, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGFetchDisputeByID(x_api_version: string, dispute_id: number, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGFetchOrderDisputes(x_api_version: string, order_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGFetchPaymentDisputes(x_api_version: string, cf_payment_id: number, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGUploadDisputesDocuments(x_api_version: string, dispute_id: number, file: string, doc_type: string, x_request_id?: string, x_idempotency_key?: string, note?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGESCreateAdjustment(x_api_version: string, vendor_id: string, x_request_id?: string, x_idempotency_key?: string, VendorAdjustmentRequest?: VendorAdjustmentRequest, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGESCreateOnDemandTransfer(x_api_version: string, vendor_id: string, x_request_id?: string, x_idempotency_key?: string, AdjustVendorBalanceRequest?: AdjustVendorBalanceRequest, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGESCreateVendors(x_api_version: string, x_request_id?: string, x_idempotency_key?: string, CreateVendorRequest?: CreateVendorRequest, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGESDownloadVendorsDocs(x_api_version: string, doc_type: string, vendor_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGESFetchVendors(x_api_version: string, vendor_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGESGetVendorBalance(x_api_version: string, vendor_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGESGetVendorBalanceTransferCharges(x_api_version: string, amount: number, rate_type: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGESGetVendorsDocs(x_api_version: string, vendor_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGESOrderRecon(x_api_version: string, x_request_id?: string, x_idempotency_key?: string, ESOrderReconRequest?: ESOrderReconRequest, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGESUpdateVendors(x_api_version: string, vendor_id: string, x_request_id?: string, x_idempotency_key?: string, UpdateVendorRequest?: UpdateVendorRequest, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGESUploadVendorsDocs(x_api_version: string, vendor_id: string, x_request_id?: string, x_idempotency_key?: string, doc_type?: string, doc_value?: string, file?: File, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGOrderSplitAfterPayment(x_api_version: string, order_id: string, x_request_id?: string, x_idempotency_key?: string, SplitAfterPaymentRequest?: SplitAfterPaymentRequest, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGOrderStaticSplit(x_api_version: string, x_request_id?: string, x_idempotency_key?: string, StaticSplitRequest?: StaticSplitRequest, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGSplitOrderRecon(x_api_version: string, order_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGEligibilityFetchCardlessEMI(x_api_version: string, EligibilityFetchCardlessEMIRequest: EligibilityFetchCardlessEMIRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGEligibilityFetchOffers(x_api_version: string, EligibilityFetchOffersRequest: EligibilityFetchOffersRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGEligibilityFetchPaylater(x_api_version: string, EligibilityFetchPaylaterRequest: EligibilityFetchPaylaterRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGEligibilityFetchPaymentMethods(x_api_version: string, EligibilityFetchPaymentMethodsRequest: EligibilityFetchPaymentMethodsRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGCreateOffer(x_api_version: string, CreateOfferRequest: CreateOfferRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGFetchOffer(x_api_version: string, offer_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGCreateOrder(x_api_version: string, CreateOrderRequest: CreateOrderRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGFetchOrder(x_api_version: string, order_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGFetchOrderExtendedData(x_api_version: string, order_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGTerminateOrder(x_api_version: string, order_id: string, TerminateOrderRequest: TerminateOrderRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGUpdateOrderExtendedData(x_api_version: string, order_id: string, UpdateOrderExtendedRequest: UpdateOrderExtendedRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGFetchRecon(x_api_version: string, FetchReconRequest: FetchReconRequest, Content_Type?: string, x_request_id?: string, x_idempotency_key?: string, Accept?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGCancelLink(x_api_version: string, link_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGCreateLink(x_api_version: string, CreateLinkRequest: CreateLinkRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGFetchLink(x_api_version: string, link_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGLinkFetchOrders(x_api_version: string, link_id: string, x_request_id?: string, x_idempotency_key?: string, status?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGAuthorizeOrder(x_api_version: string, order_id: string, AuthorizeOrderRequest: AuthorizeOrderRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGOrderAuthenticatePayment(x_api_version: string, cf_payment_id: string, OrderAuthenticatePaymentRequest: OrderAuthenticatePaymentRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGOrderFetchPayment(x_api_version: string, order_id: string, cf_payment_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGOrderFetchPayments(x_api_version: string, order_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGPayOrder(x_api_version: string, PayOrderRequest: PayOrderRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGOrderCreateRefund(x_api_version: string, order_id: string, OrderCreateRefundRequest: OrderCreateRefundRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGOrderFetchRefund(x_api_version: string, order_id: string, refund_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGOrderFetchRefunds(x_api_version: string, order_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGFetchSettlements(x_api_version: string, FetchSettlementsRequest: FetchSettlementsRequest, Content_Type?: string, x_request_id?: string, x_idempotency_key?: string, Accept?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGSettlementFetchRecon(x_api_version: string, SettlementFetchReconRequest: SettlementFetchReconRequest, Content_Type?: string, x_request_id?: string, x_idempotency_key?: string, Accept?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public MarkForSettlement(x_api_version: string, x_request_id?: string, x_idempotency_key?: string, CreateOrderSettlementRequestBody?: CreateOrderSettlementRequestBody, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGOrderFetchSettlement(x_api_version: string, order_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGFetchSimulation(x_api_version: string, simulation_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGSimulatePayment(x_api_version: string, SimulateRequest: SimulateRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SposCreateTerminal(x_api_version: string, CreateTerminalRequest: CreateTerminalRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SposCreateTerminalTransaction(x_api_version: string, CreateTerminalTransactionRequest: CreateTerminalTransactionRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SposDemapSoundboxVpa(x_api_version: string, DemapSoundboxVpaRequest: DemapSoundboxVpaRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SposFetchTerminal(x_api_version: string, terminal_phone_no: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SposFetchTerminalQRCodes(x_api_version: string, terminal_phone_no: string, cf_terminal_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SposFetchTerminalSoundboxVpa(x_api_version: string, device_serial_no: string, cf_terminal_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SposFetchTerminalTransaction(x_api_version: string, utr: string, cf_terminal_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SposOnboardSoundboxVpa(x_api_version: string, OnboardSoundboxVpaRequest: OnboardSoundboxVpaRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SposUpdateSoundboxVpa(x_api_version: string, cf_terminal_id: string, UpdateSoundboxVpaRequest: UpdateSoundboxVpaRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SposUpdateTerminal(x_api_version: string, cf_terminal_id: string, UpdateTerminalRequest: UpdateTerminalRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SposUpdateTerminalStatus(x_api_version: string, cf_terminal_id: string, UpdateTerminalStatusRequest: UpdateTerminalStatusRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SposUploadTerminalDocs(x_api_version: string, cf_terminal_id: string, UploadTerminalDocs: UploadTerminalDocs, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SubsCreatePayment(x_api_version: string, CreateSubscriptionPaymentRequest: CreateSubscriptionPaymentRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SubsCreatePlan(x_api_version: string, CreatePlanRequest: CreatePlanRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SubsCreateRefund(x_api_version: string, subscription_id: string, CreateSubscriptionRefundRequest: CreateSubscriptionRefundRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SubsCreateSubscription(x_api_version: string, CreateSubscriptionRequest: CreateSubscriptionRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SubsFetchPlan(x_api_version: string, plan_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SubsFetchSubscription(x_api_version: string, subscription_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SubsFetchSubscriptionPayment(x_api_version: string, subscription_id: string, payment_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SubsFetchSubscriptionPayments(x_api_version: string, subscription_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SubsFetchSubscriptionRefund(x_api_version: string, subscription_id: string, refund_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SubsManageSubscription(x_api_version: string, subscription_id: string, ManageSubscriptionRequest: ManageSubscriptionRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SubsManageSubscriptionPayment(x_api_version: string, subscription_id: string, payment_id: string, ManageSubscriptionPaymentRequest: ManageSubscriptionPaymentRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SubscriptionDocumentUpload(x_api_version: string, payment_id: string, file: File, payment_id2: string, action: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SubscriptionEligibility(x_api_version: string, SubscriptionEligibilityRequest: SubscriptionEligibilityRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGCustomerDeleteInstrument(x_api_version: string, customer_id: string, instrument_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGCustomerFetchInstrument(x_api_version: string, customer_id: string, instrument_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGCustomerFetchInstruments(x_api_version: string, customer_id: string, instrument_type: PGCustomerFetchInstrumentsInstrumentTypeEnum, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public PGCustomerInstrumentsFetchCryptogram(x_api_version: string, customer_id: string, instrument_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
