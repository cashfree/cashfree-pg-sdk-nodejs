 ...
 * @export
 */
export type AuthorizationDetailsPaymentMethod = AuthResponseCard | AuthResponseEnach | AuthResponsePnach | AuthResponseUpi;
 ...
 * @export
 * @interface DowntimeByIdResponse
 */
export interface DowntimeByIdResponse {
    /**
     * Unique identifier for the downtime.
     * @type {string}
     * @memberof DowntimeByIdResponse
     */
    'id'?: string;
    /**
    ...
    /**
     * 
     * @type {DowntimeObjectPaymentMethod}
     * @memberof DowntimeByIdResponse
     */
    'payment_method'?: DowntimeObjectPaymentMethod;
}
/**
 * Represents an active downtime entry in the ecosystem.
 * @export
 * @interface DowntimeObject
 */
export interface DowntimeObject {
    /**
     * Unique identifier for the downtime.
     * @type {string}
     * @memberof DowntimeObject
     */
    'downtime_id'?: string;
    /**
     ...
     * @memberof DowntimeObject
     */
    'downtime_status'?: DowntimeObjectDowntimeStatusEnum;
    /**
     * Type of the downtime (SCHEDULED or UNSCHEDULED).
     * @type {string}
     * @memberof DowntimeObject
     */
    'downtime_type'?: DowntimeObjectDowntimeTypeEnum;
    /**
     * 
     * @type {DowntimeObjectPaymentMethod}
     * @memberof DowntimeObject
...
export const DowntimeObjectDowntimeStatusEnum = {
    OPEN: 'OPEN',
    UPDATE: 'UPDATE',
    RESOLVED: 'RESOLVED',
    UNKNOWN_DEFAULT_OPEN_API: '11184809'
...
export type DowntimeObjectDowntimeStatusEnum = typeof DowntimeObjectDowntimeStatusEnum[keyof typeof DowntimeObjectDowntimeStatusEnum];
export const DowntimeObjectDowntimeTypeEnum = {
    SCHEDULED: 'SCHEDULED',
    UNSCHEDULED: 'UNSCHEDULED',
    UNKNOWN_DEFAULT_OPEN_API: '11184809'
} as const;

export type DowntimeObjectDowntimeTypeEnum = typeof DowntimeObjectDowntimeTypeEnum[keyof typeof DowntimeObjectDowntimeTypeEnum];
 ...
 * @export
 */
export type DowntimeObjectPaymentMethod = CardDowntime | NetBankingDowntime | UPIDowntime | WalletDowntime;
...
export interface FetchActiveEcosystemDowntimes200Response {
    ...
    /**
     * 
     * @type {Array<DowntimeObject>}
     * @memberof FetchActiveEcosystemDowntimes200Response
     */
    'downtimes'?: Array<DowntimeObject>;
}
/**
 * Recon object
 * @export
 ...
 */
export interface OfferExtendedDetails extends Array<string> {
}
/**
 * Filter for offers
 * @export
...
const CustomersApiAxiosParamCreator = function (cashfree: Cashfree) {
    return {
        ...
        pGCreateCustomer: async (x_api_version: string, CreateCustomerRequest: CreateCustomerRequest,  x_request_id?: string, x_idempotency_key?: string,  options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            localVarHeaderParameter['x-sdk-platform'] = 'nodejssdk-6.0.0';
...
const IntellisenseApiAxiosParamCreator = function (cashfree: Cashfree) {
    return {
         ...
         * @summary Fetch Active Ecosystem Level Downtimes
         ...
         * 
         */
        fetchActiveEcosystemDowntimes: async (x_api_version: string,   options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'x_api_version' is not null or undefined
            assertParamExists('fetchActiveEcosystemDowntimes', 'x_api_version', x_api_version)
            const localVarPath = `/intellisense/downtime`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            var url = "https://sandbox.cashfree.com/pg";
            if(cashfree.XEnvironment == CFEnvironment.PRODUCTION) {
                url = "https://api.cashfree.com/pg"
         ...
         * @param {string} id The unique identifier of the downtime incident.
         * @param {string} x_api_version API version to be used. Format is in YYYY-MM-DD
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         * 
         */
        fetchDowntimeById: async (id: string, x_api_version: string,   options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('fetchDowntimeById', 'id', id)
            // verify required parameter 'x_api_version' is not null or undefined
            assertParamExists('fetchDowntimeById', 'x_api_version', x_api_version)
            const localVarPath = `/intellisense/downtime/{id}`
...
const IntellisenseApiFp = function(cashfree: Cashfree) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async fetchActiveEcosystemDowntimes(x_api_version: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FetchActiveEcosystemDowntimes200Response>> {
                const localVarAxiosArgs = await localVarAxiosParamCreator.fetchActiveEcosystemDowntimes(x_api_version, options);
                var url = "https://sandbox.cashfree.com/pg";
                if(cashfree.XEnvironment == CFEnvironment.PRODUCTION) {
                    url = "https://api.cashfree.com/pg"
                }
         ...
         * @throws {RequiredError}
         */
        async fetchDowntimeById(id: string, x_api_version: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DowntimeByIdResponse>> {
                const localVarAxiosArgs = await localVarAxiosParamCreator.fetchDowntimeById(id, x_api_version, options);
                var url = "https://sandbox.cashfree.com/pg";
                if(cashfree.XEnvironment == CFEnvironment.PRODUCTION) {
                    url = "https://api.cashfree.com/pg"
                }
...
const PaymentsApiAxiosParamCreator = function (cashfree: Cashfree) {
    return {
         ...
         * @summary Order Pay Authorize Only
...
const UtilitiesApiAxiosParamCreator = function (cashfree: Cashfree) {
    return {
         ...
         * @summary Get bin details for a card
         
         * @param {string} x_api_version API version to be used. Format is in YYYY-MM-DD
         * @param {GetCardBinRequest} GetCardBinRequest Request payload to get card bin details.
         * @param {string} [x_request_id] Request id for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to cashfree
         * @param {string} [x_idempotency_key] An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
...
export class Cashfree {
    ...
    public FetchActiveEcosystemDowntimes(options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
            return IntellisenseApiFp(this).fetchActiveEcosystemDowntimes(x_api_version, options).then((request) => request(this.axios, this.basePath));
        } catch (error) {
            if(this.XEnableErrorAnalytics) {
                Sentry.captureException(error);
            }
    ...
    public FetchDowntimeById(id: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
            return IntellisenseApiFp(this).fetchDowntimeById(id, x_api_version, options).then((request) => request(this.axios, this.basePath));
        } catch (error) {
            if(this.XEnableErrorAnalytics) {
                Sentry.captureException(error);
            }
    ...
    public SposFetchTerminalQRCodes(terminal_phone_no: string, cf_terminal_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SposFetchTerminalSoundboxVpa(device_serial_no: string, cf_terminal_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SposFetchTerminalTransaction(utr: string, cf_terminal_id: string, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SposUpdateSoundboxVpa(cf_terminal_id: string, UpdateSoundboxVpaRequest: UpdateSoundboxVpaRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SposUpdateTerminal(cf_terminal_id: string, UpdateTerminalRequest: UpdateTerminalRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SposUpdateTerminalStatus(cf_terminal_id: string, UpdateTerminalStatusRequest: UpdateTerminalStatusRequest, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
    ...
    public SposUploadTerminalDocs(cf_terminal_id: string, UploadTerminalDocs: UploadTerminalDocs, x_request_id?: string, x_idempotency_key?: string, options?: AxiosRequestConfig) {
        const x_api_version = this.XApiVersion;
        try {
