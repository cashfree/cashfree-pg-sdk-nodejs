 ...
 * @export
 */
export const setApiKeyToObject = async function (object: any, keyParamName: string, XClientId?: string, XClientSecret?: string, XPartnerKey?: string, XPartnerMerchantId?: string, XClientSignature?: string) {
