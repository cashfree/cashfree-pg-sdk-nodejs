...
**entity_details** | [**OfferEntity**](OfferEntity.md) |  | [optional] [default to undefined]

## Example

```typescript
import { EligibilityOfferEntity } from 'cashfree-pg';

const instance: EligibilityOfferEntity = {
    eligibility,
    entity_type,
    entity_value,
    entity_details,
