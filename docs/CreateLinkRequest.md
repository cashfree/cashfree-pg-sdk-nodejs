...
------------ | ------------- | ------------- | -------------
**link_id** | **string** | Unique Identifier (provided by merchant) for the Link. Alphanumeric and only - and _ allowed (50 character limit). Use this for other link-related APIs. | [optional] [default to undefined]
**link_amount** | **number** | Amount to be collected using this link. Provide upto two decimals for paise. | [default to undefined]
**link_currency** | **string** | Currency for the payment link. Default is INR. Submit [Support Form](https://merchant.cashfree.com/auth/login) to enable new currencies. | [default to undefined]
**link_purpose** | **string** | A brief description for which payment must be collected. This is shown to the customer. | [optional] [default to undefined]
...
**enable_invoice** | **boolean** | Enable or disable invoice generation for this payment link. | [optional] [default to undefined]
