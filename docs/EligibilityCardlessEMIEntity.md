...
**entity_details** | [**CardlessEMIEntity**](CardlessEMIEntity.md) |  | [optional] [default to undefined]

## Example

```typescript
import { EligibilityCardlessEMIEntity } from 'cashfree-pg';

const instance: EligibilityCardlessEMIEntity = {
    eligibility,
    entity_type,
    entity_value,
    entity_details,
