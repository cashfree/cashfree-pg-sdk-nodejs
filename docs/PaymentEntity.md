...
------------ | ------------- | ------------- | -------------
**cf_payment_id** | **string** | Payment entity full object. | [optional] [default to undefined]
...
**bank_reference** | **string** | Issuing bank’s transaction reference number. | [optional] [default to undefined]
**auth_id** | **string** | Authorisation ID provided by the issuing bank. | [optional] [default to undefined]
