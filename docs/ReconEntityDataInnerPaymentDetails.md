...
**payment_group** | **string** | Mode of the payment. | [optional] [default to undefined]
...
```typescript
import { ReconEntityDataInnerPaymentDetails } from 'cashfree-pg';

const instance: ReconEntityDataInnerPaymentDetails = {
    payment_amount,
    payment_currency,
    bank_reference,
    payment_time,
