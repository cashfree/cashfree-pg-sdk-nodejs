...
------------ | ------------- | ------------- | -------------
**status** | **string** | Specify the status of vendor that should be updated. Possible value: ACTIVE. | [optional] [default to undefined]
**name** | **string** | Specify the name of the vendor to be updated. Name should not have any special character except . / - &amp;. | [optional] [default to undefined]
**email** | **string** | Specify the vendor email ID that should be updated. String in email ID format (Ex:johndoe_1@cashfree.com) should contain @ and dot (.). | [optional] [default to undefined]
**phone** | **string** | Specify the beneficiaries phone number to be updated. Phone number registered in India (only digits, 8 - 12 characters after excluding +91). | [optional] [default to undefined]
...
**kyc_details** | [**Array&lt;KycDetails&gt;**](KycDetails.md) | Specify the kyc details that should be updated. | [optional] [default to undefined]

## Example

```typescript
import { UpdateVendorRequest } from 'cashfree-pg';

const instance: UpdateVendorRequest = {
    status,
    name,
    email,
    phone,
