...
------------ | ------------- | ------------- | -------------
**plan_id** | **string** | Unique ID to identify the plan. Only alpha-numerics, dot, hyphen and underscore allowed. | [optional] [default to undefined]
**plan_name** | **string** | Name of the plan. | [optional] [default to undefined]
**plan_type** | **string** | Type of the plan. Possible values - PERIODIC, ON_DEMAND. | [optional] [default to undefined]
...
```typescript
import { LinkPlanEntity } from 'cashfree-pg';

const instance: LinkPlanEntity = {
    plan_id,
    plan_name,
    plan_type,
    plan_currency,
