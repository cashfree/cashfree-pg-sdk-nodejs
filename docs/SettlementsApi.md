...
|------------- | ------------- | -------------|
|[**markForSettlement**](#markforsettlement) | **POST** /orders/settlements | Mark Order For Settlement|
...
let CreateOrderSettlementRequestBody: CreateOrderSettlementRequestBody; //Create Order Settlement Request Body. (optional)

const { status, data } = await apiInstance.markForSettlement(
    x_api_version,
    x_request_id,
    x_idempotency_key,
    CreateOrderSettlementRequestBody
...
|------------- | ------------- | ------------- | -------------|
| **CreateOrderSettlementRequestBody** | **CreateOrderSettlementRequestBody**| Create Order Settlement Request Body. | |
...
const { status, data } = await apiInstance.pGOrderFetchSettlement(
    x_api_version,
    order_id,
    x_request_id,
    x_idempotency_key
